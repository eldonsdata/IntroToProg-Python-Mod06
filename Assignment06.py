...
# PShoup,11.13.2019,Modified code to complete assignment 6
# ------------------------------------------------------------------------ #
...
class FileProcessor:
    ...
    def WriteListDataToFile(file_name, list_of_rows):
        """
        Desc - Receives data from user and writes to file
        :param file_name: text file to house user input
        :param list_of_rows: list to be filled with file data
        :return:
        """
    ...
    @staticmethod
    def AddNewItem(task, priority, list_of_rows):
        """
        Desc - creates a new dictionary row
...
class IO:
    ...
    def InputNewTask():
        """
        Desc = Gets the task input from user
        :return: string
        """
    ...
    @staticmethod
    def InputTaskPriority():
        """
        Desc - Gets the priority input from user
        :return: string
        """
...
while(True):
    ...
    # Step 3.2 - Add a new item to the list/Table
        ...
        # Changed original code to function
        strTask = IO.InputNewTask()
        strPriority = IO.InputTaskPriority()

        # Step 3.2.b  Add item to the List/Table
        # Changed original code to function
        FileProcessor.AddNewItem(strTask, strPriority, lstTable)
        IO.ShowCurrentItemsInList(lstTable)  # Show current data in the list/table
        continue  # to show the menu
    ...
    # Step 3.3 - Remove a new item to the list/Table
        ...
        # Original code not replaced with function
